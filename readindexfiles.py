...
class IndexEntries(list):
    ...
    def sortByFuncGroup(self):
        ...
        #128 Gallagher 99 Gaussian peaks with Gauss noise
        #129 Gallagher 99 Gaussian peaks with uniform noise
        #130 Gallagher 99 Gaussian peaks with seldom Cauchy noise
