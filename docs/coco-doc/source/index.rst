...
.. todo:: cite [HAN2010b]_ for simulated restarts. 
...
This method is (only) available if at least one instance solved the problem. 
...
.. todo:: if we sweep over instances, we need to keep |t| constant, which raises 
