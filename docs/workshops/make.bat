...
if "%1" == "help" (
	...
	echo.  html-topublish to make HTML in the repository workshops	
...
.qhcp project file in %BUILDDIR%/qthelp, like this:
	echo.^> qcollectiongenerator %BUILDDIR%\qthelp\BBOBworkshopseries.qhcp
	echo.To view the help file:
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\BBOBworkshopseries.ghc
	goto end
)
