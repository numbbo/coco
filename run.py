...
def main(argv=None):
    ...
    flags listed below.
        ...
        -n, --no-pickle
            ...
            prevents pickle post processed data files from being generated.
    ...
    * Calling the run.py interface from the command line:
        ...
        $ python bbob_pproc/run.py experiment1
    ...
    pickle files must have been generated by earlier post-processings. 
