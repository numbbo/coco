...
static void private_evaluate_1u_ls(coco_problem_t *self, const double *x, double *y) {
...
static coco_problem_t *f_1u_linear_slope(const size_t number_of_variables, const double *best_parameter) {
  ...
  private_evaluate_1u_ls(problem, problem->best_parameter, problem->best_value);
  return problem;
}
