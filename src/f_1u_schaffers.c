...
static void private_evaluate_1u_schaff(coco_problem_t *self, const double *x, double *y) {
  size_t i;
...
static coco_problem_t *f_1u_schaffers(const size_t number_of_variables) {
  ...
  problem->evaluate_function = private_evaluate_1u_schaff;
  ...
  private_evaluate_1u_schaff(problem, problem->best_parameter, problem->best_value);
  return problem;
}
