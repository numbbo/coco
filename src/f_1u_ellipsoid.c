...
static void private_evaluate_1u_ellipsoid(coco_problem_t *self, const double *x, double *y) {
  size_t i = 0;
...
static coco_problem_t *f_1u_ellipsoid(const size_t number_of_variables) {
  ...
  problem->evaluate_function = private_evaluate_1u_ellipsoid;
  ...
  private_evaluate_1u_ellipsoid(problem, problem->best_parameter, problem->best_value);
