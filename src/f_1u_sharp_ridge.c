...
static void private_evaluate_1u_sharp_ridge(coco_problem_t *self, const double *x, double *y) {
...
static coco_problem_t *f_1u_sharp_ridge(const size_t number_of_variables) {
  ...
  problem->evaluate_function = private_evaluate_1u_sharp_ridge;
  ...
  private_evaluate_1u_sharp_ridge(problem, problem->best_parameter, problem->best_value);
  return problem;
}
