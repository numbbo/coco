...
static void _bueche_rastrigin_evaluate(coco_problem_t *self, double *x, double *y) {
    size_t i;
    double tmp = 0., tmp2 = 0.;
...
static coco_problem_t *bueche_rastrigin_problem(const size_t number_of_variables) {
    ...
    _bueche_rastrigin_evaluate(problem, problem->best_parameter, problem->best_value);
    return problem;
}
