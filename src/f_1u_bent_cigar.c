...
static void private_evaluate_1u_bent_cigar(coco_problem_t *self, const double *x, double *y) {
...
static coco_problem_t *f_1u_bent_cigar(const size_t number_of_variables) {
  ...
  problem->evaluate_function = private_evaluate_1u_bent_cigar;
  ...
  private_evaluate_1u_bent_cigar(problem, problem->best_parameter, problem->best_value);
  return problem;
}
