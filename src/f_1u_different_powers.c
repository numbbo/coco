...
static void private_evaluate_1u_different_powers(coco_problem_t *self, const double *x, double *y) {
  size_t i;
  double sum = 0.0;
...
static coco_problem_t *f_1u_different_powers(const size_t number_of_variables) {
  ...
  problem->evaluate_function = private_evaluate_1u_different_powers;
  ...
  private_evaluate_1u_different_powers(problem, problem->best_parameter, problem->best_value);
  return problem;
}
