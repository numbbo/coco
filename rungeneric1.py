...
"""Module for post-processing the data of one algorithm.
   ...
   Calls the function main with arguments from the command line.
   Executes the postprocessing on the given files and folders
   arguments, using the .info files found recursively.
...
def main(argv=None):
    ...
    template1XXX.tex or noisytemplate1XXX, where XXX is either ecj or
    generic. The template file needs to be edited so that the commands
    ...
    info files. argv can also contain post-processed pickle files
    generated by this routine. Furthermore, argv can begin with, in any
    order, facultative option flags listed below.
        ...
        -o, --output-dir OUTPUTDIR
            ...
            change the default output directory ('ppdata1') to OUTPUTDIR
    ...
    * From the python interactive shell (requires that the path to this
    ...
    folder1. The -o option changes the output folder from the default
    to outputfolder.
