...
def main(argv=None):
    ...
    folder needed for the compilation of latex document template1XXX.tex or
    noisytemplate1XXX, where XXX is either ecj or generic. The template file
    needs to be edited so that the commands \\bbobdatapath and \\algfolder
