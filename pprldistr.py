...
def comp2(dsList0, dsList1, valuesOfInterest, isStoringXMax=False,
         outputdir='', info='default', verbose=True):
    """Generate figures of empirical cumulative distribution functions.
    Dashed lines will correspond to ALG0 and solid lines to ALG1.

    Difference with comp: loops over rldStyles instead of rldColors
...
def main2(dsList, valuesOfInterest, isStoringXMax=False, outputdir='',
         info='default', verbose=True):
    """Generate figures of empirical cumulative distribution functions.

    Difference with main: loops over rldStyles instead of rldColors
