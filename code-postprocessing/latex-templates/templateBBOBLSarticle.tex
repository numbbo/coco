...
\ifthenelse{\isundefined{\numofalgs}}
{
		\newcommand{\numberofalgorithms}{one}
           ...
           \ifthenelse{\isundefined{\algorithmC}}
	  {
...
benchmark functions given in \cite{bbobls2019func} are
presented in
%%
\ifthenelse{\equal{\numberofalgorithms}{one}}{
Figures~\ref{fig:aRTgraphs}, \ref{fig:ECDFs}, and \ref{fig:ECDFsingleOne} and Tables~\ref{tab:aRTs80} and \ref{tab:aRTs320}.
}{\ifthenelse{\equal{\numberofalgorithms}{two}}{
Figures~\ref{fig:scaling}, \ref{fig:scatterplots}, \ref{fig:ECDFs80D}, \ref{fig:ECDFs320D} and \ref{fig:ECDFsingleOne}, and Tables~\ref{tab:aRTs80} and \ref{tab:aRTs320}.
}{\ifthenelse{\equal{\numberofalgorithms}{three}}{
Figures~\ref{fig:scaling}, \ref{fig:ECDFs80D}, \ref{fig:ECDFs320D}, and \ref{fig:ECDFsingleOne} and Tables~\ref{tab:aRTs80} and \ref{tab:aRTs320}.
}{}}}
%%
...
\bbobpptablesmanylegend{dimension $80$}
}
\end{table*}
...
\bbobpptablesmanylegend{dimension $320$}
}
\end{table*}
