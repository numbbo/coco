...
Figures~\ref{fig:ECDFsingleOne}, \ref{fig:ECDFsingleTwo}, \ref{fig:ECDFsingleThree}, \ref{fig:RLDsGroupsOne}, and \ref{fig:RLDsGroupsTwo} and in
Table~\ref{tab:ERTs}.
...
\end{tabular}
 ...
 %\bbobppfigdimlegend{$f_1$ and $f_{16}$}
\TODO{figure caption to be written}
 }
\end{figure*}
\begin{figure*}
\centering
...
\end{tabular}
 ...
 Empirical cumulative distribution function (ECDF) of the restarted algorithm per dimension for all targets of each function as in Fig.~\ref{fig:ECDFsingleOne} but for $f_{17}$ till $f_{36}$.
 }
\end{figure*}
\begin{figure*}
\centering
...
\TODO{This caption does not say exactly what is shown in the table due to a current bug
...
\vspace{-3ex}
 ...
 ERT vs.\ dimension as in Fig.~\ref{fig:ERTgraphs} but for $f_{31}$ till $f_{55}$.
 }
\end{figure*}
