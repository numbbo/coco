...
\newcommand{\blueline}{\arrayrulecolor{blue}\hline\arrayrulecolor{black}}
\newcommand{\greenline}{\arrayrulecolor{green}\hline\arrayrulecolor{black}}
...
%Conference
\acmConference[GECCO '22]{the Genetic and Evolutionary Computation Conference 2022}{July 9--13, 2022}{Boston, MA, USA}
\acmYear{2022}
\copyrightyear{2022}
