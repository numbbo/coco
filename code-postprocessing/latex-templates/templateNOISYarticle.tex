...
\begin{figure*}
   \begin{tabular}{@{}c@{}c@{}}
      ...
      \includegraphics[width=0.49\textwidth, trim=0mm 0mm 0mm 12mm, clip]{pprldmany-single-functions/pprldmany_nzmod} & 
			\includegraphics[width=0.49\textwidth, trim=0mm 0mm 0mm 12mm, clip]{pprldmany-single-functions/pprldmany_nzsev}\\[2em]
			{\Large\sffamily severe noise multimod.} & {\Large\sffamily all functions}\\
      \includegraphics[width=0.49\textwidth, trim=0mm 0mm 0mm 12mm, clip]{pprldmany-single-functions/pprldmany_nzsmm} &
			\includegraphics[width=0.49\textwidth, trim=0mm 0mm 0mm 12mm, clip]{pprldmany-single-functions/pprldmany}
    \end{tabular}
...
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f101}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f104}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f107}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f110}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f113}\\[-1.8ex]
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f102}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f105}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f108}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f111}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f114}\\[-1.8ex]
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f103}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f106}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f109}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f112}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f115}\\\hline\\[-1.8ex]
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f116}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f119}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f122}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f125}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f128}\\[-1.8ex]
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f117}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f120}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f123}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f126}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f129}\\[-1.8ex]
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f118}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f121}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f124}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f127}&
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f130}\\[-1.8ex]
\end{tabular}
...
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f101}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f104}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f107}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f110}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f113}\\
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f102}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f105}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f108}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f111}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f114}\\
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f103}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f106}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f109}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f112}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f115}\\
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f116}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f119}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f122}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f125}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f128}\\
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f117}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f120}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f123}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f126}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f129}\\
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f118}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f121}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f124}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f127}&
\includegraphics[width=0.2\textwidth, trim=12mm 2mm 12mm 2mm, clip]{ppfigs_f130}
\end{tabular}
   ...
   \begin{tabular}{@{}c@{}c@{}c@{}}
      \,\, & 5-D & 20-D\\
			\rot{\Large\sffamily \,\,\,\,\,\,\,\,\,\,all functions}\hspace{1em} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_05D_nzall} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_20D_nzall}\\[1em]
			\rot{\Large\sffamily \,\,\,\,\,moderate noise}\hspace{1em} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_05D_nzmod} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_20D_nzmod}\\[1em]
			\rot{\Large\sffamily \,\,\,\,\,\,\,\,\,\,\,severe noise}\hspace{1em} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_05D_nzsev} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_20D_nzsev}\\[1em]
			\rot{\Large\sffamily \!\!severe noise multimod.}\hspace{1em} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_05D_nzsmm} &
			   \includegraphics[height=0.25\textwidth, trim=0mm 0mm 0mm 0mm, clip]{pprldmany_20D_nzsmm}
    \end{tabular}
...
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f113_10D}\\[-1.8ex]
...
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f114_10D}\\[-1.8ex]
...
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f115_10D}\\[-1.8ex]
...
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f128_10D}\\[-1.8ex]
...
\includegraphics[width=0.2\textwidth]{pprldmany-single-functions/pprldmany_f129_10D}\\[-1.8ex]
...
\bbobpptablesmanylegend{dimension $5$}{30}
}
\end{table*}
...
\end{minipage}}
 ...
 \bbobpptablesmanylegend{dimension $20$}{30}
 }
\end{table*}
...
\begin{turn}{90}\parbox{0.175\textwidth}{\centering\sf Gauss noise\vspace{1em}}\end{turn} &
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f101}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f104}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f107}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f110}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f113}\\
...
\begin{turn}{90}\parbox{0.175\textwidth}{\centering\sf uniform noise\vspace{1em}}\end{turn} &
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f102}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f105}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f108}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f111}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f114}\\
...
\begin{turn}{90}\parbox{0.175\textwidth}{\centering\sf Cauchy noise\vspace{1em}}\end{turn} &
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f103}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f106}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f109}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f112}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f115}\\\hline
 & {\sf 116 Ellipsoid} & {\sf 119 Sum of diff.\ powers} & {\sf 122 Schaffer F7} & {\sf 125 Griewank-Rosenbrock} & {\sf 128 Gallagher}\\
\begin{turn}{90}\parbox{0.175\textwidth}{\centering\sf Gauss noise\vspace{1em}}\end{turn} &
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f116}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f119}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f122}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f125}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f128}\\
 & {\sf 117 Ellipsoid} & {\sf 120 Sum of diff.\ powers} & {\sf 123 Schaffer F7} & {\sf 126 Griewank-Rosenbrock} & {\sf 129 Gallagher}\\
\begin{turn}{90}\parbox{0.175\textwidth}{\centering\sf uniform noise\vspace{1em}}\end{turn} &
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f117}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f120}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f123}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f126}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f129}\\
& {\sf 118 Ellipsoid} & {\sf 121 Sum of diff.\ powers} & {\sf 124 Schaffer F7} & {\sf 127 Griewank-Rosenbrock} & {\sf 130 Gallagher}\\
\begin{turn}{90}\parbox{0.175\textwidth}{~\centering\sf Cauchy noise\vspace{1em}}\end{turn} &
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f118}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f121}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f124}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f127}&
    \includegraphics[height=0.175\textwidth, trim= 36mm 8mm 28mm 12mm, clip]{ppscatter_f130}\\[-1em]
\end{tabular}
