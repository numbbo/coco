...
def build_matlab():
    ...
    copy_file('code-experiments/build/matlab/coco.c', 'code-experiments/examples/biobj-matlab-smsemoa/coco.c')
    copy_file('code-experiments/src/coco.h', 'code-experiments/examples/biobj-matlab-smsemoa/coco.h')
    copy_file('code-experiments/src/best_values_hyp.txt', 'code-experiments/examples/biobj-matlab-smsemoa/best_values_hyp.txt')
    copy_file('code-experiments/build/matlab/cocoEvaluateFunction.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoEvaluateFunction.c')
    copy_file('code-experiments/build/matlab/cocoObserver.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoObserver.c')
    copy_file('code-experiments/build/matlab/cocoObserverFree.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoObserverFree.c')
    copy_file('code-experiments/build/matlab/cocoProblemAddObserver.c', 'code-experiments/examples/biobj-matlab-smsemoa/ProblemAddObserver.c')
    copy_file('code-experiments/build/matlab/cocoProblemFree.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemFree.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetDimension.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemgetDimension.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetEvaluations.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemGetEvaluations.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetId.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemGetId.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetLargestValuesOfInterest.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemGetLargestValuesOfInterest.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetName.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemGetName.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetNumberOfObjectives.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemGetNumberOfObjectives.c')
    copy_file('code-experiments/build/matlab/cocoProblemGetSmallestValuesOfInterest.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemGetSmallestValuesOfInterest.c')
    copy_file('code-experiments/build/matlab/cocoProblemIsValid.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoProblemIsValid.c')
    copy_file('code-experiments/build/matlab/cocoSuite.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoSuite.c')
    copy_file('code-experiments/build/matlab/cocoSuiteFree.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoSuiteFree.c')
    copy_file('code-experiments/build/matlab/cocoSuiteGetNextProblem.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoSuiteGetNextProblem.c')
    copy_file('code-experiments/build/matlab/cocoSuiteGetNextProblemIndex.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoSuiteGetNextProblemIndex.c')
    copy_file('code-experiments/build/matlab/cocoSuiteGetProblem.c', 'code-experiments/examples/biobj-matlab-smsemoa/cocoSuiteGetProblem.c')
