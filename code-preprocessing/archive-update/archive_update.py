# -*- coding: utf-8 -*-
"""Methods for updating the archives of solutions to bi-objective probelms.
        ...
        for file_name in self.file_names:            
            with open(file_name, 'r') as f:
                ...
                if not instance_found:
                    raise PreprocessingException("File '{}' does not contain "
...
class ArchiveInfo:
    ...
    def __init__(self, input_path):
        ...
        if (len(input_files) == 0):
            raise PreprocessingException("Folder '{}' does not exist or is "
...
if __name__ == '__main__':
    ...
    # Use files with best hypervolume values from the src folder and update them
    # with the new best values
