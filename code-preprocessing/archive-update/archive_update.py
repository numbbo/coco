# -*- coding: utf-8 -*-
"""Methods for updating the archives of solutions to bi-objective problems.
   
   Input archives are read and merged so that only non-dominated solutions are stored in the output archives. A file
   with the best known hypervolume values is generated from these hypervolumes and the ones stored in C source files.
"""
        ...
        for f_name in self.file_names:
            with open(f_name, 'r') as f:
                ...
                if not instance_found:
                    raise PreprocessingException('File \'{}\' does not contain \'instance = {}\''.format(file_name,
                                                                                                         self.instance))
...
if __name__ == '__main__':
    ...
    file_names = [os.path.abspath(os.path.join(basepath, '..', '..', 'code-experiments/src', file_name))
