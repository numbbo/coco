...
#DBLP:conf/gecco/Ros10 NEWUOA AVG FULL noisefree
#DBLP:conf/gecco/Ros10a NEWUOA AVG FULL noisy
#DBLP:conf/gecco/Ros10b IPOPCMA BIPOP noisefree
#DBLP:conf/gecco/Ros10c IPOP BIPOP noisy
#DBLP:conf/gecco/HansenR10 NEWUOA BIPOP noisefree
#DBLP:conf/gecco/FialhoGC10 PM Adap DE Unif noisefree
#DBLP:conf/gecco/FialhoSS10a F-AUC et PM Adapt DE noisefree
#DBLP:conf/gecco/AugerBH10 (1+1) (1+2)ms noisefree
#DBLP:conf/gecco/AugerBH10a (1, 2), (1, 2) m, (1, 2)ms noisefree
#DBLP:conf/gecco/AugerBH10b (1, 4), (1, 4) m, (1, 4)ms noisefree
#DBLP:conf/gecco/Kubalik10a POEMS noisefree
#DBLP:conf/gecco/AugerBH10c (1,2), (1, 2)m, (1, 2)ms noisy
#DBLP:conf/gecco/AugerBH10d (1,4), (1, 4)m, (1, 4)ms noisy
#DBLP:conf/gecco/AugerBH10e (1,2), (1, 2)s noisefree
#DBLP:conf/gecco/AugerBH10f (1,4), (1, 4)s noisefree
#DBLP:conf/gecco/AugerBH10g (1,2), (1, 2)s noisy
#DBLP:conf/gecco/AugerBH10h (1,4), (1, 4)s noisy
#DBLP:conf/gecco/AugerBH10i (1, 4) ms noisefree
#DBLP:conf/gecco/AugerBH10j (1,4) ms CMA-ES and s noisy
#DBLP:conf/gecco/FinckB10 CMA-EGS noisefree
#DBLP:conf/gecco/FinckB10a CMA-EGS noisy
#DBLP:conf/gecco/LaTorreMP10 MOS? noisefree
#DBLP:conf/gecco/FinckB10b SPSA noisefree
#DBLP:conf/gecco/FinckB10c SPSA noisy
#DBLP:conf/gecco/HansenR10a Act CMA noisefree
#DBLP:conf/gecco/HansenR10b Act CMA noisy
#DBLP:conf/gecco/HansenARFP10 31 algorithms BBOB 2009
#DBLP:conf/gecco/Posik10 Cauchy BIPOP noisefree
#DBLP:conf/gecco/PosikK10 Cauchy EDA pPOEMS noisefree
#DBLP:conf/gecco/Preuss10 Niche CMA noisefree?
#DBLP:conf/gecco/El-Abd10 ABC noisefree
#DBLP:conf/gecco/LaTorreMP10a MOS? noisy
#DBLP:conf/gecco/TranJ10 RCGA noisefree
#DBLP:conf/gecco/TranJ10a RCGA noisy
#DBLP:conf/gecco/Posik10a Cauchy Rosenbrock noisefree
#DBLP:conf/gecco/Posik10b Cauchy G3PCX noisefree
#DBLP:conf/gecco/Posik10c G3PCX Rosenbrock noisefree

# Hard coded references:
noisefreebibref = {
    "ALPS-GA": ["Hornby:2009"],
    "AMaLGaM IDEA": ["DBLP:conf/gecco/BosmanGT09"],
    "iAMaLGaM IDEA": ["DBLP:conf/gecco/BosmanGT09"],
    "BayEDAcG": ["DBLP:conf/gecco/Gallagher09"],
    "BFGS": ["DBLP:conf/gecco/Ros09"],
    "BIPOP-CMA-ES": ["DBLP:conf/gecco/Hansen09", "DBLP:conf/gecco/Ros10b", "DBLP:conf/gecco/HansenR10", "DBLP:conf/gecco/Posik10"],
    "Cauchy EDA": ["DBLP:conf/gecco/Posik09", "DBLP:conf/gecco/Posik10", "DBLP:conf/gecco/PosikK10", "DBLP:conf/gecco/Posik10a", "DBLP:conf/gecco/Posik10b"],
    "(1+1)-CMA-ES": ["DBLP:conf/gecco/AugerH09"],
    "DASA": ["DBLP:conf/gecco/KorosecS09"],
    "DEPSO": ["DBLP:conf/gecco/Garcia-NietoAA09"],
    "DIRECT": ["DBLP:conf/gecco/Posik09a"],
    "EDA-PSO": ["DBLP:conf/gecco/El-AbdK09"],
    "CMA-EGS": ["Finck:2009"],
    "G3-PCX": ["DBLP:conf/gecco/Posik09b", "DBLP:conf/gecco/Posik10b", "DBLP:conf/gecco/Posik10c"],
    "simple GA": ["DBLP:conf/gecco/Nicolau09"],
    "GLOBAL": ["Pal:2009a"],
    "LSfminbnd": ["DBLP:conf/gecco/Posik09c"],
    "LSstep": ["DBLP:conf/gecco/Posik09c"],
    "MA-LS-Chain": ["DBLP:conf/gecco/MolinaLH09"],
    "MCS": ["Huyer:2009b"],
    "NELDER (Han)": ["DBLP:conf/gecco/Hansen09b"],
    "NELDER (Doe)": ["DBLP:conf/gecco/DoerrFSW09"],
    "NEWUOA": ["DBLP:conf/gecco/Ros09b", "DBLP:conf/gecco/Ros10", "DBLP:conf/gecco/HansenR10"],
    "full NEWUOA": ["DBLP:conf/gecco/Ros09b", "DBLP:conf/gecco/Ros10"],
    "(1+1)-ES": ["DBLP:conf/gecco/Auger09", "DBLP:conf/gecco/AugerBH10"],
    "POEMS": ["DBLP:conf/gecco/Kubalik09a"],
    "PSO": ["DBLP:conf/gecco/El-AbdK09a"],
    "PSO\_Bounds": ["DBLP:conf/gecco/El-AbdK09b"],
    "Monte Carlo": ["DBLP:conf/gecco/AugerR09"],
    "Rosenbrock": ["DBLP:conf/gecco/Posik09d", "DBLP:conf/gecco/Posik10a", "DBLP:conf/gecco/Posik10c"],
    "IPOP-SEP-CMA-ES": ["DBLP:conf/gecco/Ros09d"],
    "VNS (Garcia)": ["DBLP:conf/gecco/Garcia-MartinezL09"],
    "(1,2)-CMA-ES": ["DBLP:conf/gecco/AugerBH10a", "DBLP:conf/gecco/AugerBH10e"],
    "(1,2m)-CMA-ES": ["DBLP:conf/gecco/AugerBH10a"],
    "(1,2ms)-CMA-ES": ["DBLP:conf/gecco/AugerBH10a"],
    "(1,2s)-CMA-ES": ["DBLP:conf/gecco/AugerBH10e"],
    "(1,4)-CMA-ES": ["DBLP:conf/gecco/AugerBH10b", "DBLP:conf/gecco/AugerBH10f"],
    "(1,4m)-CMA-ES": ["DBLP:conf/gecco/AugerBH10b"],
    "(1,4ms)-CMA-ES": ["DBLP:conf/gecco/AugerBH10i", "DBLP:conf/gecco/AugerBH10b"],
    "(1,4s)-CMA-ES": ["DBLP:conf/gecco/AugerBH10f"],
    "(1+2ms)-CMA-ES": ["DBLP:conf/gecco/AugerBH10"],
    "Artif Bee Colony": ["DBLP:conf/gecco/El-Abd10"],
    "avg NEWUOA": ["DBLP:conf/gecco/Ros10"],
    "CMA-EGS (IPOP,r1)": ["DBLP:conf/gecco/FinckB10"],
    "Adap DE (F-AUC)": ["DBLP:conf/gecco/FialhoSS10a"],
    "DE (Uniform)": ["DBLP:conf/gecco/FialhoGC10"],
    "IPOP-aCMA-ES": ["DBLP:conf/gecco/HansenR10a"],
    "IPOP-CMA-ES": ["DBLP:conf/gecco/Ros10b"],
    "CMA+DE-MOS": ["DBLP:conf/gecco/LaTorreMP10"],
    "NBC-CMA": ["DBLP:conf/gecco/Preuss10"],
    "POEMS": ["DBLP:conf/gecco/Kubalik10a"],
    "PM-AdapSS-DE": ["DBLP:conf/gecco/FialhoGC10", "DBLP:conf/gecco/FialhoSS10a"],
    "pPOEMS": ["DBLP:conf/gecco/Kubalik10a", "DBLP:conf/gecco/PosikK10"],
    "Basic RCGA": ["DBLP:conf/gecco/TranJ10"],
    "SPSA": ["DBLP:conf/gecco/FinckB10b"]
}

noisybibref = {
    "ALPS-GA": ["Hornby:2009a"],
    "AMaLGaM IDEA": ["DBLP:conf/gecco/BosmanGT09a"],
    "iAMaLGaM IDEA": ["DBLP:conf/gecco/BosmanGT09a"],
    "avg NEWUOA": ["DBLP:conf/gecco/Ros10a"],
    "full NEWUOA": ["DBLP:conf/gecco/Ros09c", "DBLP:conf/gecco/Ros10a"],
    "BayEDAcG": ["DBLP:conf/gecco/Gallagher09a"],
    "BFGS": ["DBLP:conf/gecco/Ros09a"],
    "BIPOP-CMA-ES": ["DBLP:conf/gecco/Hansen09a", "DBLP:conf/gecco/Ros10c"],
    "(1+1)-CMA-ES": ["DBLP:conf/gecco/AugerH09a"],
    "DASA": ["DBLP:conf/gecco/KorosecS09a"],
    "DEPSO": ["DBLP:conf/gecco/Garcia-NietoAA09a"],
    "EDA-PSO": ["DBLP:conf/gecco/El-AbdK09"],
    "CMA-EGS": ["Finck:2009a"],
    "GLOBAL": ["Pal:2009"],
    "MA-LS-Chain": ["DBLP:conf/gecco/MolinaLH09a"],
    "MCS": ["Huyer:2009a"],
    "(1+1)-ES": ["DBLP:conf/gecco/Auger09a"],
    "PSO": ["DBLP:conf/gecco/El-AbdK09a"],
    "PSO\_Bounds": ["DBLP:conf/gecco/El-AbdK09b"],
    "Monte Carlo": ["DBLP:conf/gecco/AugerR09a"],
    "IPOP-SEP-CMA-ES": ["DBLP:conf/gecco/Ros09e"],
    "SNOBFIT": ["Huyer:2009"],
    "VNS (Garcia)": ["DBLP:conf/gecco/Garcia-MartinezL09a"],
    "(1,2)-CMA-ES": ["DBLP:conf/gecco/AugerBH10c", "DBLP:conf/gecco/AugerBH10g"],
    "(1,2m)-CMA-ES": ["DBLP:conf/gecco/AugerBH10c"],
    "(1,2ms)-CMA-ES": ["DBLP:conf/gecco/AugerBH10c"],
    "(1,2s)-CMA-ES": ["DBLP:conf/gecco/AugerBH10g"],
    "(1,4)-CMA-ES": ["DBLP:conf/gecco/AugerBH10d", "DBLP:conf/gecco/AugerBH10h"],
    "(1,4m)-CMA-ES": ["DBLP:conf/gecco/AugerBH10d"],
    "(1,4ms)-CMA-ES": ["DBLP:conf/gecco/AugerBH10j", "DBLP:conf/gecco/AugerBH10d"],
    "(1,4s)-CMA-ES": ["DBLP:conf/gecco/AugerBH10h"],
    "avg NEWUOA": ["DBLP:conf/gecco/Ros10a"],
    "CMA-EGS (IPOP,r1)": ["DBLP:conf/gecco/FinckB10a"],
    "IPOP-aCMA-ES": ["DBLP:conf/gecco/HansenR10b"],
    "IPOP-CMA-ES": ["DBLP:conf/gecco/Ros10c"],
    "CMA+DE-MOS": ["DBLP:conf/gecco/LaTorreMP10a"],
    "NEWUOA": ["DBLP:conf/gecco/Ros10a"],
    "Basic RCGA": ["DBLP:conf/gecco/TranJ10a"],
    "SPSA": ["DBLP:conf/gecco/FinckB10c"]
}
...
def cite(algName, isNoisefree, isNoisy):
    ...
    try:
        if isNoisefree:
            res = noisefreebibref[algName]
        if isNoisy:
            res = noisybibref[algName]
    except KeyError:
        txt = '%s is not listed in the references.' % algName
        warnings.warn(txt)
