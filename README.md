...
5. **Postprocess** that data from the results folder by typing
  ...
  different batches be either provided in several arguments or collected in 
  one root folder. We can also compare more than one algorithm by specifying
  data result folders generated by different algorithms.
