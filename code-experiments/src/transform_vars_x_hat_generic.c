 ...
 * Wassim: TODO: should eventually replace the non generic version in its use in
 * Schwefel where xopt would be set elsewhere
 */
 ...
 */
static void transform_vars_x_hat_generic_evaluate(coco_problem_t *problem,
                                                  const double *x, double *y) {
  size_t i;
  transform_vars_x_hat_generic_data_t *data;
  coco_problem_t *inner_problem;
  data =
      (transform_vars_x_hat_generic_data_t *)coco_problem_transformed_get_data(
          problem);
...
static void transform_vars_x_hat_generic_free(void *thing) {
  transform_vars_x_hat_generic_data_t *data =
      (transform_vars_x_hat_generic_data_t *)thing;
...
transform_vars_x_hat_generic(coco_problem_t *inner_problem,
                             const double *sign_vector) {
  transform_vars_x_hat_generic_data_t *data;
  coco_problem_t *problem;
  size_t i;

  data = (transform_vars_x_hat_generic_data_t *)coco_allocate_memory(
      sizeof(*data));
  ...
  problem = coco_problem_transformed_allocate(inner_problem, data,
                                              transform_vars_x_hat_generic_free,
