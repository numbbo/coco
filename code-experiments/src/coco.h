 ...
 *
 * All public functions, constants and variables are defined in the file coco.h. It is the authoritative
 ...
 * COCO (COmparing Continuous Optimisers) is a platform for systematic and sound comparisons of
 * real-parameter global optimisers. COCO provides benchmark function testbeds, experimentation templates
 * which are easy to parallelize, and tools for processing and visualizing data generated by one or
 * several optimizers.
 * 
 ...
 *  - how to write new test functions and to combine them to test suites
 *  - how to write additional performance indicators and logging functionality
 * 
 * \subsection links Pointers to the source code and other documentation
 * The actual source code of COCO can be found at http://github.com/numbbo
 * 
...
/* Definitions of some 32 and 64-bit types (used only by the random number generator) */
#ifdef _MSC_VER
...
/* math.h is needed for NAN among other things */
#include <math.h>
#ifndef NAN
