 ...
 * top trumps decks. A bi-objective version can be found in the file suite_rw_top_trumps_biobj.c
 *
 * The suite contains 5 problems with dimensions 88, 128, 168, 208 and 15 instances.
 */
 ...
 */
static coco_suite_t *suite_rw_top_trumps_initialize(void) {
...
static coco_problem_t *suite_rw_top_trumps_get_problem(coco_suite_t *suite,
  ...
  problem = rw_top_trumps_problem_allocate(suite->suite_name, 1, function, dimension, instance);
  assert(problem != NULL);
