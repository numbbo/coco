 ...
 */
static double
f_discus_generalized_raw(const double *x, const size_t number_of_variables,
                         f_discus_generalized_versatile_data_t
                             *f_discus_generalized_versatile_data) {
  ...
  nb_short_axes =
      number_of_variables /
      f_discus_generalized_versatile_data->proportion_short_axes_denom;
...
f_discus_generalized_allocate(const size_t number_of_variables,
                              size_t proportion_short_axes_denom) {

  coco_problem_t *problem = coco_problem_allocate_from_scalars(
      "generalized discus function", f_discus_generalized_evaluate,
      f_discus_generalized_versatile_data_free, number_of_variables, -5.0, 5.0,
      0.0);
  coco_problem_set_id(problem, "%s_d%04lu", "discus_generalized",
                      number_of_variables);
  problem->versatile_data =
      (f_discus_generalized_versatile_data_t *)coco_allocate_memory(
          sizeof(f_discus_generalized_versatile_data_t));
  ((f_discus_generalized_versatile_data_t *)problem->versatile_data)
      ->proportion_short_axes_denom = proportion_short_axes_denom;

  /* Compute best solution */
  f_discus_generalized_evaluate(problem, problem->best_parameter,
                                problem->best_value);
  return problem;
}
 ...
 */
static coco_problem_t *f_discus_generalized_permblockdiag_bbob_problem_allocate(
  ...
  problem =
      f_discus_generalized_allocate(dimension, proportion_short_axes_denom);
