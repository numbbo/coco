 ...
 *
 * The suite contains 10 problems with dimensions 88, 128, 168, 208 and 15 instances.
 */
...
static coco_suite_t *suite_rw_top_trumps_biobj_initialize(void) {
  ...
  suite = coco_suite_allocate("rw-top-trumps-biobj", 10, 4, dimensions, "instances: 1-15");
