 ...
 * @brief Implementation of adding a penalty to the objective value for
 * solutions outside of the ROI in the decision space.
 */
...
static void transform_obj_penalize_evaluate(coco_problem_t *problem,
  ...
  transform_obj_penalize_data_t *data =
      (transform_obj_penalize_data_t *)coco_problem_transformed_get_data(
          problem);
