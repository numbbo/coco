 ...
 */
static void transform_vars_scale_evaluate(coco_problem_t *problem,
  ...
  data =
      (transform_vars_scale_data_t *)coco_problem_transformed_get_data(problem);
 ...
 */
static coco_problem_t *transform_vars_scale(coco_problem_t *inner_problem,
                                            const double factor) {
  transform_vars_scale_data_t *data;
  ...
  problem = coco_problem_transformed_allocate(
      inner_problem, data, transform_vars_scale_free, "transform_vars_scale");
