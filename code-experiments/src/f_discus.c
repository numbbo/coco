 ...
 */
static void f_discus_evaluate_gradient(coco_problem_t *problem, const double *x,
                                       double *y) {
...
static coco_problem_t *f_discus_allocate(const size_t number_of_variables) {
  ...
  coco_problem_t *problem = coco_problem_allocate_from_scalars(
      "discus function", f_discus_evaluate, NULL, number_of_variables, -5.0,
      5.0, 0.0);
...
f_discus_bbob_problem_allocate(const size_t function, const size_t dimension,
 ...
 */
static coco_problem_t *f_discus_cons_bbob_problem_allocate(
