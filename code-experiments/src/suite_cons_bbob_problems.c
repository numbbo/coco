...
static size_t obj_function_type(const size_t function) {
  ...
  return (size_t)ceil((double)function /
                      (double)problems_per_obj_function_type);
}
...
static void feasible_direction_set_length(double *feasible_direction,
                                          const double *xopt, size_t dimension,
                                          long rseed) {
  ...
  for (i = 0; i < dimension; ++i) {
    ...
    maxrel =
        coco_double_max(maxrel, feasible_direction[i] / (feas_bound - xopt[i]));
    maxrel = coco_double_max(maxrel,
                             feasible_direction[i] / (-feas_bound - xopt[i]));
  }
  if (maxabs > 4.01)
    coco_warning("feasible_direction_set_length: a component of fabs(xopt) was "
                 "greater than 4.01");
  if (maxabs > 5.0)
    coco_error("feasible_direction_set_length: a component of fabs(xopt) was "
               "greater than 5.0");
 ...
 *        Constraint(s): linear
 */
static coco_problem_t *f_sphere_c_linear_cons_bbob_problem_allocate(
   ...
   */
  problem_c = c_linear_cons_bbob_problem_allocate(
      function, dimension, instance, number_of_linear_constraints,
      problem_id_template, problem_name_template, feasible_direction);

  problem_type_temp = coco_strdup(problem->problem_type);
  problem = coco_problem_stacked_allocate(
      problem, problem_c, problem_c->smallest_values_of_interest,
 ...
 *        Constraint(s): linear
 */
static coco_problem_t *f_ellipsoid_c_linear_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const size_t number_of_linear_constraints, const long rseed,
    double *feasible_direction, const double *xopt,
    const char *problem_id_template, const char *problem_name_template) {
  ...
  /* Create the objective function */
  problem = f_ellipsoid_cons_bbob_problem_allocate(
...
static coco_problem_t *f_ellipsoid_rotated_c_linear_cons_bbob_problem_allocate(
  ...
  /* Create the objective function */
  problem = f_ellipsoid_rotated_cons_bbob_problem_allocate(
      function, dimension, instance, rseed, problem_id_template,
      problem_name_template);
 ...
 *        Constraint(s): linear
 */
static coco_problem_t *f_linear_slope_c_linear_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const size_t number_of_linear_constraints, const long rseed,
    double *feasible_direction, const double *xopt,
    const char *problem_id_template, const char *problem_name_template) {
  ...
  /* Create the objective function */
  problem = f_linear_slope_bbob_problem_allocate(function, dimension, instance,
 ...
 *        Constraint(s): linear
 */
static coco_problem_t *f_discus_c_linear_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const size_t number_of_linear_constraints, const long rseed,
    double *feasible_direction, const double *xopt,
    const char *problem_id_template, const char *problem_name_template) {
  ...
  /* Create the objective function */
  problem = f_discus_cons_bbob_problem_allocate(function, dimension, instance,
                                                rseed, problem_id_template,
                                                problem_name_template);
 ...
 *        Constraint(s): linear
 */
static coco_problem_t *f_bent_cigar_c_linear_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const size_t number_of_linear_constraints, const long rseed,
    double *feasible_direction, const double *xopt,
    const char *problem_id_template, const char *problem_name_template) {
  ...
  /* Create the objective function */
  problem = f_bent_cigar_cons_bbob_problem_allocate(
      function, dimension, instance, rseed, problem_id_template,
      problem_name_template);
...
static coco_problem_t *f_different_powers_c_linear_cons_bbob_problem_allocate(
  ...
  /* Create the objective function */
  problem = f_different_powers_bbob_constrained_problem_allocate(
      function, dimension, instance, rseed, problem_id_template,
      problem_name_template);
 ...
 *        Constraint(s): linear
 */
static coco_problem_t *f_rastrigin_c_linear_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const size_t number_of_linear_constraints, const long rseed,
    double *feasible_direction, const double *xopt,
    const char *problem_id_template, const char *problem_name_template) {
  ...
  /* Create the objective function */
  problem = f_rastrigin_cons_bbob_problem_allocate(
      function, dimension, instance, rseed, problem_id_template,
      problem_name_template);
...
static coco_problem_t *f_rastrigin_rotated_c_linear_cons_bbob_problem_allocate(
  ...
  /* Create the objective function */
  problem = f_rastrigin_rotated_cons_bbob_problem_allocate(
      function, dimension, instance, rseed, problem_id_template,
      problem_name_template);
