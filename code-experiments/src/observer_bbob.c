 ...
 */
typedef struct {
  /* TODO: Can be used to store variables that need to be accessible during one
   * run (i.e. for multiple problems). For example, the following global
   * variables from logger_bbob.c could be stored here: */
  size_t current_dim;
