 ...
 *
 * @brief The best known hypervolume values for the bbob-biobj and
 * bbob-biobj-ext suite problems.
 *
 * @note For now, the hypervolume reference values for the bbob-biobj-ext
 * problems not in the bbob-biobj suite are 1.0 as well as for the new instances
 * larger than 10 (as of 2017/01/20).
 *
...
static const char *suite_biobj_best_values_hyp[] =
    {/* Best values on 29.01.2017 16:30:00, copied from: best values current
        data, 10.07.2016 */
