...
static coco_problem_t *f_rastrigin_allocate(const size_t number_of_variables) {
  ...
  coco_problem_t *problem = coco_problem_allocate_from_scalars(
      "Rastrigin function", f_rastrigin_evaluate, NULL, number_of_variables,
      -5.0, 5.0, 0.0);
  /* TODO: make sure the gradient is computed correctly for the rotated
   * Rastrigin */
...
f_rastrigin_bbob_problem_allocate(const size_t function, const size_t dimension,
 ...
 */
static coco_problem_t *f_rastrigin_rotated_bbob_problem_allocate(
 ...
 */
static coco_problem_t *f_rastrigin_permblockdiag_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const long rseed, const char *problem_id_template,
    const char *problem_name_template) {
  double *xopt, fopt;
 ...
 */
static coco_problem_t *f_rastrigin_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const long rseed, const char *problem_id_template,
    const char *problem_name_template) {
 ...
 */
static coco_problem_t *f_rastrigin_rotated_cons_bbob_problem_allocate(
    const size_t function, const size_t dimension, const size_t instance,
    const long rseed, const char *problem_id_template,
    const char *problem_name_template) {
  ...
  problem = f_rastrigin_allocate(dimension);
  problem = transform_vars_shift(problem, xopt, 0);
  problem = transform_vars_affine(
      problem, M, b,
      dimension); /* Rotate after shifting so R dot xopt is also rotated */
  problem = transform_obj_shift(problem, fopt);
