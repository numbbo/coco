...
static void transform_obj_shift_evaluate_function(coco_problem_t *problem,
  ...
  data =
      (transform_obj_shift_data_t *)coco_problem_transformed_get_data(problem);
...
static coco_problem_t *transform_obj_shift(coco_problem_t *inner_problem,
  ...
  problem->evaluate_gradient =
      transform_obj_shift_evaluate_gradient; /* TODO (NH): why do we need a new
