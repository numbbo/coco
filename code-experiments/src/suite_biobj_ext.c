...
static coco_suite_t *suite_biobj_ext_initialize(void) {
  ...
  suite = coco_suite_allocate("bbob-biobj-ext", 55+37, 6, dimensions, "year: 2019");
...
static const char *suite_biobj_ext_get_instances_by_year(const int year) {
  ...
  /* TODO: This should be simply treated as "else" since there will be no year-based instances for
