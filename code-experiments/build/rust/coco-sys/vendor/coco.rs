...
extern "C" {
    ...
    pub static coco_version: [::std::os::raw::c_char; 10usize];
}
...
extern "C" {
    ...
    pub fn coco_suite_get_number_of_problems(suite: *const coco_suite_t) -> usize;
}
extern "C" {
...
extern "C" {
    ...
    pub fn coco_problem_get_dimension(problem: *const coco_problem_t) -> usize;
}
extern "C" {
    #[doc = " @brief Returns the number of objectives of the problem."]
    pub fn coco_problem_get_number_of_objectives(problem: *const coco_problem_t) -> usize;
}
extern "C" {
    #[doc = " @brief Returns the number of constraints of the problem."]
    pub fn coco_problem_get_number_of_constraints(problem: *const coco_problem_t) -> usize;
}
extern "C" {
    #[doc = " @brief Returns the number of objective function evaluations done on the problem."]
    pub fn coco_problem_get_evaluations(problem: *const coco_problem_t) -> usize;
}
extern "C" {
    #[doc = " @brief Returns the number of constraint function evaluations done on the problem."]
    pub fn coco_problem_get_evaluations_constraints(problem: *const coco_problem_t) -> usize;
}
extern "C" {
...
extern "C" {
    ...
    pub fn coco_problem_get_number_of_integer_variables(problem: *const coco_problem_t) -> usize;
}
extern "C" {
...
extern "C" {
    ...
    pub fn coco_problem_get_suite_dep_index(problem: *const coco_problem_t) -> usize;
}
extern "C" {
...
extern "C" {
    ...
    pub fn coco_allocate_memory(size: usize) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    #[doc = " @brief Safe memory allocation for a vector of doubles that either succeeds or triggers a coco_error."]
    pub fn coco_allocate_vector(size: usize) -> *mut f64;
}
extern "C" {
...
extern "C" {
    ...
    pub fn coco_archive_get_number_of_solutions(archive: *mut coco_archive_t) -> usize;
}
extern "C" {
