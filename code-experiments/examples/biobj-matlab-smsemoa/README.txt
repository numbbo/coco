...
implementation by Tobias Wagner and Fabian Kretzschmar on the
biobjective BBOB test suite using the new COCO framework.
...
the algorithm is configured and run via run_smsemoa_on_biobj.m which
