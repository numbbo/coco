...
- The paper [_Using Well-Understood Single-Objective Functions in Multiobjective Black-Box Optimization Test Suites_](https://hal.inria.fr/hal-01296987) describes the suite construction in detail (accepted for publication in ECJ).
